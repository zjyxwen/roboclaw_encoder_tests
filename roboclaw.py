...
class Roboclaw:
	...
	def __init__(self, comport, rate, timeout=0.2, retries=3):
	...
	def Open(self):
		try:
			self._port = serial.Serial(port=self.comport, baudrate=self.rate, timeout=self.timeout, write_timeout=self.timeout, interCharTimeout=self.timeout)
		except:
			return 0
		return 1
